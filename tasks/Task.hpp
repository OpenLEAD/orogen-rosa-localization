...
#ifndef ROSA_LOCALIZATION_TASK_TASK_HPP
#define ROSA_LOCALIZATION_TASK_TASK_HPP
...
namespace rosa_localization {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','rosa_localization::Task')
     end
     \endverbatim
    ...
    public:
         ...
         */
        Task(std::string const& name = "rosa_localization::Task");
